...
iowa_file_path = 'kaggle/input/iowa_home_data/train.csv'
...
# Using DecisionTreeRegressor - best value for max_leaf_nodes
...
forest_model_predictions = iowa_forest_model.predict(val_X)
